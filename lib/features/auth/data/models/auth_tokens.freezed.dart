...
mixin _$AuthTokens {
  ...
  @override
  String toString() {
    return 'AuthTokens(accessToken: $accessToken, refreshToken: $refreshToken, tokenType: $tokenType, expiresIn: $expiresIn, refreshExpiresIn: $refreshExpiresIn)';
  }
}
    ...
    switch (_that) {
      case _AuthTokens() when $default != null:
        return $default(_that.accessToken, _that.refreshToken, _that.tokenType,
            _that.expiresIn, _that.refreshExpiresIn);
      case _:
        return orElse();
    }
  }
...
class _AuthTokens implements AuthTokens {
  const _AuthTokens(
      ...
      @JsonKey(name: 'expires_in') this.expiresIn = 300,
      @JsonKey(name: 'refresh_expires_in') this.refreshExpiresIn = 1800});
